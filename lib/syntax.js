...
const Syntax = {
  ...
  arithmetic: {
    ...
    expr: () => {
      return Syntax.arithmetic.chainl1(term, addOp);
    },
    term: () => {
      return Syntax.arithmetic.chainr1(factor, multiplyOp);
    },
    factor: () => {
      return Parser.alt(Syntax.num(), Parser.bracket(Syntax.arithmetic.open, expr, Syntax.arithmetic.close));
    }
  },
  //  +, -, *, /, % 
  binOperator: (_) => {
